...
for( from in unique(dat_all$From) ){
    ...
    plot <- ggplot(dat_tmp, aes(x = Class_use , y = BurdenExon, color = Class , fill = Class)) +
    ...
    out_name <- paste0(out_path , "/Fig2_mutationburden.pdf")
